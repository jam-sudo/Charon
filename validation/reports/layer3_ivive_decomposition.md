...
**Generated:** 2026-04-24T06:34:16.493356+00:00
...
| --- | --- |
| n_compounds | 12 |
| aggregate_pct_liver_model | 6.164 |
| aggregate_pct_route_bias | 0.000 |
| aggregate_pct_residual | 93.84 |
...
| atorvastatin | 2.154 | 2.788 | 2.593 | 68.08 | 88.1 | 81.95 | 0.000 | 10 | oral | oral | oral | 0.14 | 0.2154 | 0.7728 | 1 | 0.2788 | 4.642 | 1.294 | 3.587 | parallel_tube | - | Lennernas 2003 | F ~0.14 reflects OATP1B1 hepatic uptake + CYP3A4 first-pass |
...
- liver_model choice: 6.2%
- 1/F route bias: 0.0% (expected near 0%; simulation route now matches reference)
- residual: 93.8%

The route-bias collapse confirms Sprint 10's diagnostic: the 42% previously attributed to 1/F was a route-comparison artefact. What remains in the residual is the true IVIVE / transporter / mechanistic gap. Top-5 residuals:

| Compound | fold_residual |
|---|---:|
| propranolol | 27.49 |
| diclofenac | 10.12 |
| diazepam | 4.91 |
...
Sprint 12 (OATP1B1) and Sprint 13 (UGT/CYP2C9) scopes are now tighter — with route-bias neutralised, each remaining residual has a clearer mechanistic attribution.
